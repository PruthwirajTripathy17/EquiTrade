  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5">
            <i class="fa-solid fa-user"></i> Your EquiTrade Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Login Credentials
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5">
            <i class="fa-solid fa-chart-column"></i> Your EquiTrade Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5">
            <i class="fa-solid fa-wallet"></i> Account Opening
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Adding Funds
          </a>
